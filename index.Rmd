...
`pixiedust` comes with two core functions. The `dust` function converts an object to a tabular structure associated with its formatting choices.  The `sprinkle` function acts on the `dust` object to change those associations as directed by the user.
