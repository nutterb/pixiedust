...
#' \dontrun{
#' # to use in tests
#' dust_colnames(col_names = c("Term", "Estimate", "SE", "T", "p"))
#' dust_colnames(term = c("Term", "SE"), std.error = "SE", p.value = "p")
#' dust_colnames(term = "Term", std.error = "SE", p.value = "p")
#' dust_colnames(term = "Term", "SE", "p")
#' dust_colnames("Term", "SE", "p")
#' }
