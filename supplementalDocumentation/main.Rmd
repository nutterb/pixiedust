...
TO DO: Put tips and links here about using colors that are multiple-format safe.

## Sprinkles

[Sprinkles and Print Methods](Sprinkles-print-methods.html)

[Sprinkle Usage Overview](Sprinkles-usage.html) (A Duplicate of the `?sprinkle` documentation from the package)


## Miscellaneous

Working with multiple tables (coming soon)

[LaTeX Tables and `hhline`](latex-output-hhline.pdf) (in progress)

## Answers to `xtable` questions on StackOverflow

I know, this is kind of a lame section, but looking at what people are trying to do with `xtable` helps me find flaws and opportunities for improving `pixiedust`.  Some of these may appear on StackOverflow as answers, most probably won't.  

[R, Latex and RMarkdown: table() input for xtable() missing column and row labels?](xtable-SO-01.pdf)

[Shiny renderTable add.to.row](xtable-SO-02.html)
